            ...
            request(url[i], function(error, response, html){
                ...
                if (!gfn_isNull(url2)) {
                    ...
                    request(url2, function(error, response, html) {
                        ...
                        // Text_Value = $("div.contents_style").children("h2").eq(1).text()+"\n";

                        // for (var i = 0; i < $("div.contents_style").children("p").length; i++){
                        //     Text_Value += $("div.contents_style").children("p").eq(i).text() + "\n";
                        // }
